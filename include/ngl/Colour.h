...
public :
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Colour(Real _r=0.0, Real _g=0.0,  Real _b=0.0, Real _a=1.0)  :
  ...
  //----------------------------------------------------------------------------------------------------------------------
  void set( Real _r,Real _g, Real _b, Real _a=1.0f) 
  {
     m_r=_r; m_g=_g; m_b=_b; m_a=_a;
  }
  //----------------------------------------------------------------------------------------------------------------------
  ...
  /// @return this*_c
  //----------------------------------------------------------------------------------------------------------------------
  Colour operator *(const Real _c) const ;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  void clamp( Real _min, Real _max) ;
