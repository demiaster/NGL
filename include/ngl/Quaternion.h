...
class NGL_DLLEXPORT Quaternion
{
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Quaternion(const Real _s=0.0f,const Real _x=0.0f,const Real _y=0.0f,const Real _z=0.0f)  :
          m_s(_s),
          m_x(_x),
          m_y(_y),
          m_z(_z) {;}
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Quaternion operator *(Real _s ) const  ;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Quaternion  conjugate() const   {return Quaternion(m_s,-m_x,-m_y,-m_z);}
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief  conjugate negate the vector part can also be done by the -() operator
  /// @returns the conjugate of the current quaternion
  //----------------------------------------------------------------------------------------------------------------------
  ...
  /// @returns the conjugate of the current quaternion
  //----------------------------------------------------------------------------------------------------------------------
  void operator -()  {m_x=-m_x; m_y=-m_y; m_z=-m_z;}
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  Quaternion operator-() const   {return Quaternion(m_s,-m_x,-m_y,-m_z ); }
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  static Quaternion slerp(const Quaternion &_q1,const Quaternion &_q2,const Real &_t)  ;
  ...
  /// @param[in] _angle the angle of rotation around the Z axis in degrees
  //----------------------------------------------------------------------------------------------------------------------
  void fromAxisAngle(const Vec3 &_axis,Real _angle)  ;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  void fromEulerAngles(const Real _x,const Real _y,const Real _z)  ;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  void rotatePoint(const Quaternion& _r,Vec3 & io_p)  ;
  //----------------------------------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------------------------------
  void toAxisAngle(Vec3 &o_axis,Real &o_angle)  ;
  //----------------------------------------------------------------------------------------------------------------------
