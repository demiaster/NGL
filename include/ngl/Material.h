...
public :
  ...
  //----------------------------------------------------------------------------------------------------------------------
  inline void setAmbient(const Colour &_c) noexcept{ m_ambient = _c;}
  inline Colour getAmbient() const noexcept {return m_ambient;}
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief mutator to set the Diffuse colour value
  /// @param[in] _c  colour values to be set
  //----------------------------------------------------------------------------------------------------------------------
  inline void setDiffuse(const Colour &_c) noexcept{ m_diffuse = _c;}
  inline Colour getDiffuse() const noexcept {return m_diffuse;}
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief mutator to set the Specular colour value
  /// @param[in] _c  colour values to be set
  //----------------------------------------------------------------------------------------------------------------------
  inline void setSpecular(const Colour &_c) noexcept{ m_specular = _c;}
  inline Colour getSpecular() const  noexcept{return m_specular;}
  //----------------------------------------------------------------------------------------------------------------------
  /// @brief mutator to set the specular exponent colour value
  /// @param[in] _s  specular exponent value smaller = larger highlights
  //----------------------------------------------------------------------------------------------------------------------
  inline void setSpecularExponent(Real _s) noexcept{ m_specularExponent=_s;}
  inline Real getSpecularExponent()const  noexcept{ return m_specularExponent;}

  inline Real getTransparency()const  noexcept{ return m_transparency;}

  //----------------------------------------------------------------------------------------------------------------------
  /// @brief mutator to set the surface roughness, will effect the spread in shading
  /// @param[in] _r  value to set
  //----------------------------------------------------------------------------------------------------------------------
  inline void setRoughness(Real _r) noexcept{m_surfaceRoughness=_r;}
  inline Real getRoughness()const  noexcept{return m_surfaceRoughness;}
